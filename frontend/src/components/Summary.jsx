    ...
    return (
        <div className='min-h-screen bg-[#F5E6A8]'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 my-6'>
                ...
                <div className='bg-[#5E3023] text-white p-4 rounded-lg shadow-md flex flex-col items-center justify-center'>
                ...
                <div className='bg-[#001524] text-white p-4 rounded-lg shadow-md flex flex-col items-center justify-center'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                ...
                <div className='bg-[#F5E6C8] p-4 rounded-lg shadow-md'>
                ...
                <div className='bg-[#F5E6C8] p-4 rounded-lg shadow-md'>
                    ...
                    {dashboardData.highestSaleProduct?.name ? (
                        <div className='text-gray-600'>
                            <p>
                                <strong>Nmae:</strong>{dashboardData.highestSaleProduct.name}
                            </p>
                            <p>
                                <strong>Category:</strong> {dashboardData.highestSaleProduct.category}
                            </p>
                            <p>
                                <strong>Total Units Sold:</strong> {dashboardData.highestSaleProduct.totalQuantity}
                            </p>
                        </div>
                    ) : (
                        <p className='text-gray-500'>
